...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ ',
            'price' =>'800',
            'image' => 'src/public/images/kiwi.png',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' =>'1200',
            'image' => 'src/public/images/strawberry.png',
        ...
        'name' => 'オレンジ',
        'price' =>'850',
        'image' => 'src/public/images/orange.png',
    ...
    DB::table('products')->insert($param);
        $param = [
            'name' => 'スイカ',
            'price' =>'700',
            'image' => 'src/public/images/watermelon.png',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' =>'1000',
            'image' => 'src/public/images/peach.png',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' =>'1400',
            'image' => 'src/public/images/muscat.png',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' =>'800',
            'image' => 'src/public/images/pineapple.png',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' =>'1100',
            'image' => 'src/public/images/grapes.png',
        ...
        $param = [
            'name' => 'バナナ',
            'price' =>'600',
            'image' => 'src/public/images/banana.png',
        ...
        'name' => 'メロン',
        'price' =>'900',
        'image' => 'src/public/images/melon.png',
